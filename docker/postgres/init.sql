-- CoTrain PostgreSQL Initialization Script
...
VALUES 
    ('admin@cotrain.ai', 'admin', crypt('admin123', gen_salt('bf')), 'Admin', 'User', 'admin', 'active', true),
    ('trainer@cotrain.ai', 'trainer', crypt('trainer123', gen_salt('bf')), 'Trainer', 'User', 'trainer', 'active', true),
    ('participant@cotrain.ai', 'participant', crypt('participant123', gen_salt('bf')), 'Participant', 'User', 'participant', 'active', true);
...
CREATE UNIQUE INDEX idx_daily_stats_date ON analytics.daily_stats(date);
